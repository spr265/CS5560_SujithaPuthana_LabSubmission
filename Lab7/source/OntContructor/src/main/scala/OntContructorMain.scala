...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val ontology = manager.createOntology(IRI.create(ONTOLOGYURI, "premierLeague#"))
    //Prefix for all the entities
    val pm = new DefaultPrefixManager(null, null, ONTOLOGYURI + "premierLeague#")


    // Declaration Axiom for creating Classes
    val classes = Source.fromFile("mydata/Class").getLines()
    ...
    val objprop = Source.fromFile("mydata/ObjectProperties").getLines()
    objprop.foreach(f => {
      val farr = f.split(",")
    ...
    val dataprop = Source.fromFile("mydata/DataProperties").getLines()
    ...
    val individuals = Source.fromFile("mydata/Individuals").getLines()
    ...
    val triplets = Source.fromFile("mydata/Triplets").getLines()
    triplets.foreach(f => {
      val farr = f.split(",")
    ...
    val os = new FileOutputStream("mydata/premierLeague.owl")
